...
// account array.
func checkStateAccounts(t *testing.T, db store.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db store.Database, root common.Hash) error {
...
func checkStateConsistency(db store.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(store.Database), srcRoot)
