...
func (c *BoundContract) Call(opts *CallOpts, result interface{}, method string, params ...interface{}) error {
	...
	var (
		msg    = juchain.CallMsg{From: opts.From, To: &c.address, Data: input}
...
func (c *BoundContract) transact(opts *TransactOpts, contract *common.Address, input []byte) (*types.Transaction, error) {
	...
	if gasLimit == 0 {
		...
		msg := juchain.CallMsg{From: opts.From, To: contract, Value: value, Data: input}
	...
	signedTx, err := opts.Signer(types.DefaultSigner{}, opts.From, rawTx)
	if err != nil {
		return nil, err
	}
