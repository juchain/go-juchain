...
with each log line:
    ...
    // later
    requestlogger.Debug("store txn commit", "duration", txnTimer.Finish())

This will output a log line that includes the path context that is attached to the logger:

    lvl=dbug t=2014-05-02T16:07:23-0700 path=/repo/12/add_hook msg="store txn commit" duration=0.12
