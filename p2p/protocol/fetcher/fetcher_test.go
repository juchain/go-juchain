...
var (
	...
	genesis      = core.GenesisBlockForTesting(testdb, testAddress, big.NewInt(100000000000000))
	unknownBlock = types.NewBlock(&types.Header{GasLimit: config.GenesisGasLimit}, nil, nil, nil)
)
...
func makeChain(n int, seed byte, parent *types.Block) ([]common.Hash, map[common.Hash]*types.Block) {
	blocks, _ := core.GenerateChain(config.TestChainConfig, parent, consensus.CreateFakeEngine(), testdb, n, func(i int, block *core.BlockGen) {
