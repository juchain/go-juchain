...
type downloadTester struct {
	...
	stateDb store.Database // Database used by the tester for syncing from peers
	peerDb  store.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb, _ = store.NewMemDatabase()
...
func (dl *downloadTester) makeChain(n int, seed byte, parent *types.Block, parentReceipts types.Receipts, heavy bool) ([]common.Hash, map[common.Hash]*types.Header, map[common.Hash]*types.Block, map[common.Hash]types.Receipts) {
	...
	blocks, receipts := core.GenerateChain(config.TestChainConfig, parent, dpos.New(&config.DPoSConfig{}, nil), dl.peerDb, n, func(i int, block *core.BlockGen) {
		...
		if parent == dl.genesis && i%3 == 0 {
			signer := types.MakeSigner(config.TestChainConfig, block.Number())
			tx, err := types.SignTx(types.NewTransaction(block.TxNonce(testAddress), common.Address{seed}, big.NewInt(1000), config.TxGas, nil, nil), signer, testKey)
			if err != nil {
				panic(err)
			}
			block.AddTx(tx)
...
func TestCanonicalSynchronisation63Full(t *testing.T)  { testCanonicalSynchronisation(t, 2, FullSync) }
func TestCanonicalSynchronisation63Fast(t *testing.T)  { testCanonicalSynchronisation(t, 2, FastSync) }
...
func TestThrottling63Fast(t *testing.T) { testThrottling(t, 2, FastSync) }
...
func TestHeavyForkedSync63Fast(t *testing.T)  { testHeavyForkedSync(t, 2, FastSync) }
...
func TestBoundedForkedSync63Fast(t *testing.T)  { testBoundedForkedSync(t, 2, FastSync) }
...
func TestBoundedHeavyForkedSync62(t *testing.T)      { testBoundedHeavyForkedSync(t, 1, FullSync) }
func TestBoundedHeavyForkedSync63Full(t *testing.T)  { testBoundedHeavyForkedSync(t, 2, FullSync) }
func TestBoundedHeavyForkedSync63Fast(t *testing.T)  { testBoundedHeavyForkedSync(t, 2, FastSync) }
...
func TestCancel62(t *testing.T)      { testCancel(t, 1, FullSync) }
func TestCancel63Full(t *testing.T)  { testCancel(t, 2, FullSync) }
func TestCancel63Fast(t *testing.T)  { testCancel(t, 2, FastSync) }
...
func TestMultiSynchronisation62(t *testing.T)      { testMultiSynchronisation(t, 1, FullSync) }
func TestMultiSynchronisation63Full(t *testing.T)  { testMultiSynchronisation(t, 2, FullSync) }
func TestMultiSynchronisation63Fast(t *testing.T)  { testMultiSynchronisation(t, 2, FastSync) }
...
func TestMultiProtoSynchronisation62(t *testing.T)      { testMultiProtoSync(t, 1, FullSync) }
func TestMultiProtoSynchronisation63Full(t *testing.T)  { testMultiProtoSync(t, 2, FullSync) }
func TestMultiProtoSynchronisation63Fast(t *testing.T)  { testMultiProtoSync(t, 2, FastSync) }
...
func testMultiProtoSync(t *testing.T, protocol int, mode SyncMode) {
	...
	tester.newPeer("peer 1", 1, hashes, headers, blocks, nil)
	tester.newPeer("peer 2", 2, hashes, headers, blocks, receipts)
...
func TestEmptyShortCircuit62(t *testing.T)      { testEmptyShortCircuit(t, 1, FullSync) }
func TestEmptyShortCircuit63Full(t *testing.T)  { testEmptyShortCircuit(t, 2, FullSync) }
func TestEmptyShortCircuit63Fast(t *testing.T)  { testEmptyShortCircuit(t, 2, FastSync) }
...
func TestMissingHeaderAttack62(t *testing.T)      { testMissingHeaderAttack(t, 1, FullSync) }
func TestMissingHeaderAttack63Full(t *testing.T)  { testMissingHeaderAttack(t, 2, FullSync) }
func TestMissingHeaderAttack63Fast(t *testing.T)  { testMissingHeaderAttack(t, 2, FastSync) }
...
func TestShiftedHeaderAttack62(t *testing.T)      { testShiftedHeaderAttack(t, 1, FullSync) }
func TestShiftedHeaderAttack63Full(t *testing.T)  { testShiftedHeaderAttack(t, 2, FullSync) }
func TestShiftedHeaderAttack63Fast(t *testing.T)  { testShiftedHeaderAttack(t, 2, FastSync) }
...
func TestInvalidHeaderRollback63Fast(t *testing.T)  { testInvalidHeaderRollback(t, 2, FastSync) }
...
func TestHighTDStarvationAttack62(t *testing.T)      { testHighTDStarvationAttack(t, 1, FullSync) }
func TestHighTDStarvationAttack63Full(t *testing.T)  { testHighTDStarvationAttack(t, 2, FullSync) }
func TestHighTDStarvationAttack63Fast(t *testing.T)  { testHighTDStarvationAttack(t, 2, FastSync) }
...
func TestBlockHeaderAttackerDropping62(t *testing.T) { testBlockHeaderAttackerDropping(t, 1) }
...
func TestSyncProgress62(t *testing.T)      { testSyncProgress(t, 1, FullSync) }
func TestSyncProgress63Full(t *testing.T)  { testSyncProgress(t, 2, FullSync) }
func TestSyncProgress63Fast(t *testing.T)  { testSyncProgress(t, 2, FastSync) }
...
// revertal).
func TestForkedSyncProgress62(t *testing.T)      { testForkedSyncProgress(t, 1, FullSync) }
func TestForkedSyncProgress63Full(t *testing.T)  { testForkedSyncProgress(t, 2, FullSync) }
func TestForkedSyncProgress63Fast(t *testing.T)  { testForkedSyncProgress(t, 2, FastSync) }
...
func TestFailedSyncProgress62(t *testing.T)      { testFailedSyncProgress(t, 1, FullSync) }
func TestFailedSyncProgress63Full(t *testing.T)  { testFailedSyncProgress(t, 2, FullSync) }
func TestFailedSyncProgress63Fast(t *testing.T)  { testFailedSyncProgress(t, 2, FastSync) }
...
func TestFakedSyncProgress62(t *testing.T)      { testFakedSyncProgress(t, 1, FullSync) }
func TestFakedSyncProgress63Full(t *testing.T)  { testFakedSyncProgress(t, 2, FullSync) }
func TestFakedSyncProgress63Fast(t *testing.T)  { testFakedSyncProgress(t, 2, FastSync) }
