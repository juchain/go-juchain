...
directory. Mode instance A opens the database "store", node instance B opens the databases
"store" and "store-2". The following files will be created in the data directory:

   data-directory/
        A/
            nodekey            -- devp2p node key of instance A
            nodes/             -- devp2p discovery knowledge database of instance A
            store/                -- LevelDB content for "store"
        ...
        B/
            ...
            store/                -- LevelDB content for "store"
            store-2/              -- LevelDB content for "store-2"
